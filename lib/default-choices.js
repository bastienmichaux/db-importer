...
/**
 * todo we must 'select' everything, so basically just forward the item in the correct key
 * todo But we must also format it se it has the same format as after inquirer. Careful not to duplicate this formatting job
 */
