...
/**
 * return the user session with a new property 'columns'
 * the 'columns' property holds all the columns of the selected tables
 *
    ...
    const promisedQuery = query => new Promise((resolve, reject) => {
        ...
        session.connection.query(query, (error, results) => {
            ...
            results.forEach((result) => {
                tableColumns[result.table_name].push(result.column_name);
            });
